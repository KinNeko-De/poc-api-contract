...
- Services
    - [DocumentService](#kinnekodedocumentgrpcv1documentservice)
...
- Messages
    ...
    - [UploadDocumentRequest.Metadata](#uploaddocumentrequestmetadata)
...
| ----- | ---- | ----------- |
| created_at | [ google.protobuf.Timestamp](#googleprotobuftimestamp) | Timestamp when the current file was uploaded the first time |
| uploaded_at | [ google.protobuf.Timestamp](#googleprotobuftimestamp) | Timestamp when the current revision was uploaded |
...
> **rpc** UploadDocument([UploadDocumentRequest](#uploaddocumentrequest))
    [UploadDocumentResponse](#uploaddocumentresponse)


## DownloadDocument

> **rpc** DownloadDocument([DownloadDocumentRequest](#downloaddocumentrequest))
    [DownloadDocumentResponse](#downloaddocumentresponse)
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| document_id | [ kinnekode.protobuf.Uuid](#kinnekodeprotobufuuid) | none |
 <!-- end Fields -->
 <!-- end HasFields -->
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) file.metadata | [ kinnekode.document.UploadedFileMetadata](#kinnekodedocumentuploadedfilemetadata) | none |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) file.chunk | [ bytes](#bytes) | none |
 <!-- end Fields -->
 <!-- end HasFields -->
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) file.metadata | [ UploadDocumentRequest.Metadata](#uploaddocumentrequestmetadata) | none |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) file.chunk | [ bytes](#bytes) | none |
 <!-- end Fields -->
 <!-- end HasFields -->
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| request_id | [ kinnekode.protobuf.Uuid](#kinnekodeprotobufuuid) | none |
